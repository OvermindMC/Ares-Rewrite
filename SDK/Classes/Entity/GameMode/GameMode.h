...
public:
    ...
    virtual auto startBuildBlock(Vec3<int>*, unsigned __int8) -> void;
    ...
    virtual auto useItemOn(class ItemStack*, Vec3<int>*, unsigned __int8, Vec3<float>*, class Block*) -> class InteractionResult*;
